...
import {ListGoodImage} from "@/admin/components/GoodsImage/ListGoodImage"
...
const App = (): ReactElement => (
    <div>
        ...
        <Admin dataProvider={dataProvider}>
            <Resource name="clients" list={ListGuesser} create={CreateClient} edit={EditClient} show={ShowGuesser}
                      recordRepresentation="id"/>
            <Resource name="goods" list={ListGuesser} create={CreateGood} edit={EditGood} show={ShowGuesser}
                      recordRepresentation="name"/>
            <Resource name="goods-images" list={ListGoodImage} create={CreateGoodsImage} edit={EditGoodsImage}
                      show={ShowGuesser} recordRepresentation="id"/>
        </Admin>
    </div>
);
export default App